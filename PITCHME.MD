## Prakash Subedi, MS-CS, OCP, ACS
##### <span style="font-family:Helvetica Neue; font-weight:bold">A <span style="color:#e49436">Prakash's</span>Expereinces Tour</span>

---

## Bootcamp Instructor at the Iron Yard 
<span style="font-size:0.6em; color:gray">Java Back-End Ingineering Instructor</span> |
<span style="font-size:0.6em; color:gray">Corporate Training Instructor - Full Stack</span>

 *  Taught 12 week immersive coding bootcamp at NOVA Workforce covering
    ** Java 8 console application |
    ** Mobile Applciation using Android Studio |  
    ** Web Application using Spring MVC | 
    ** REST API Development using Spring REST | 
    ** REST API documentation using Swagger | 
    ** Database Operations using Spring Data, JPA, Hibernate |
    ** Securig APPs/API's using Spring Security | 
    ** Starting a Spring project using Spring Boot | 
    ** Building web user interface using HTML/CSS w/ Bootstrap | 
    ** Consuming REST API's using JavaScript, AJAX, AngularJS http service | 
    ** Consuming third party API using Spring RestTemplate  |
    ** Developing Single Page Applications using Angular Components | 
    ** Source code version cotrol using Git and GitHub  |
    ** Build automation using Maven and Jenkins | 
    ** Deploying SpringBoot apps/apis to Cloud using Heroku CLI, AWS Beanstalk |
    ** Organizing development progress using Agile/Scrum celebrations | 
    ** more ...
---
